...
for i=1:iRows
    ...
    if acq.ActivChNum == 2
        CHN1 = Segment(1:acq.ActivChNum:end,:,:);
    ...
    CH1max = squeeze(peak2peak(CHN1, 1));
    CH3max = squeeze(peak2peak(CHN3, 1));
    CH2max = squeeze(peak2peak(CHN2, 1));
    CH4max = squeeze(peak2peak(CHN4, 1));
