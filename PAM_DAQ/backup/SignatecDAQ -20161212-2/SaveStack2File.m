function SaveStack2File(handles, params, ImgName)
...
fwp.Value.pathname = [getappdata(0, 'datadir'), '\', ImgName, '\', ImgName, '.rd8'];
        
disp('Saving acquisition data to file...\n');


ReadSampleRamFileBufPX4res = calllib('signalib', 'ReadSampleRamFileBufPX4', handles.phBrd, 0,...
    RAMChunk * ceil(ActivChNum * AcqLengthMicroSec * SamplingRateMHz * PixNum * RowNum/ RAMChunk), fwp.Value)
