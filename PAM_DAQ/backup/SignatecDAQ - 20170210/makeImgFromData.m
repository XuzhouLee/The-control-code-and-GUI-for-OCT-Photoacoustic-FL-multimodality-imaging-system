...
if acq.ActivChNum ~= 1
   ...
   figure(121); imagesc(uint8(CH1max)); colormap gray
end

figure(123); imagesc(uint8(CH3max)); colormap gray
...
if acq.ActivChNum == 4
    ...
    figure(122); imagesc(uint8(CH2max)); colormap gray
    figure(124); imagesc(uint8(CH4max)); colormap gray
